/**
 * WarriorPlayer - Warrior class implementation
 * Warrior-specific mechanics (Rage, stances, etc.)
 * This class will be refactored to extend Character in a future update
 */
class WarriorPlayer {
    ...
    initializeClass(config) {
        // Warrior-specific initialization is done in constructor
        // This method satisfies the Character interface
    }
...
// Maintain backward compatibility - Player alias for WarriorPlayer
class Player extends WarriorPlayer {
}
